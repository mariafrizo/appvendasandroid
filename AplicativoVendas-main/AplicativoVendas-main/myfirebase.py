...
class MyFirebase:
    ...
    def criar_conta(self, email, senha):
        ...
        if requisicao.ok:
            ...
            req_id = requests.get("https://aplicativovendashash-95608-default-rtdb.firebaseio.com/proximo_id_vendedor.json")
            id_vendedor = req_id.json()
            print("id_vendedor:", id_vendedor)

            # criar usuario no banco de dados
            link = f"https://aplicativovendashash-95608-default-rtdb.firebaseio.com/{local_id}.json"
            ...
            requests.patch("https://aplicativovendashash-95608-default-rtdb.firebaseio.com/.json", data=info_id_vendedor)
