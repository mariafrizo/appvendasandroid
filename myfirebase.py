...
class MyFirebase:
    API_KEY = "AIzaSyBuONoJdoN--5Nld0AVoRZppHoDRSmuqik"
    ...
    def criar_conta(self, email, senha):
        ...
        if requisicao.ok:
            ...
            # requisicao_dic["idToken"] -> autenticacão
            ...
            req_id = requests.get(f"https://aplicativovendashash-95608-default-rtdb.firebaseio.com/proximo_id_vendedor.json?auth={id_token}")
            id_vendedor = req_id.json()
            print("id_vendedor:", id_vendedor)

            # criar usuario no banco de dados
            link = f"https://aplicativovendashash-95608-default-rtdb.firebaseio.com/{local_id}.json?auth={id_token}"
            ...
            requests.patch("https://aplicativovendashash-95608-default-rtdb.firebaseio.com/.json?auth={id_token}", data=info_id_vendedor)
